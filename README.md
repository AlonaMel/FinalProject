...
**If you would like to run and check the final performance, just use the file [facerec_direct.ipynb](https://github.com/JoyceHao/FinalProject/blob/master/Face_Recog/facerec_direct.ipynb) in the Face_Recog folder and run all the block directly.**

<br /><br />

## Project Stucture:

There are 3 files are too big to upload, we upload them on google drive. If you'd like to run the code, please download and move them to the correct folders.
